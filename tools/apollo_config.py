...
''' data split '''
# your dataset path
train_json_paths = '/media/sda3/apollo/data_splits/illus_chg/train.json'
test_json_paths = '/media/sda3/apollo/data_splits/illus_chg/test.json'
data_base_path = '/media/sda3/apollo/Apollo_Sim_3D_Lane_Release'

model_save_path = "/media/sda2/CaliFree3DLane/dataset/model/apollo/"
