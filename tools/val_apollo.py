...
# model_path = '/media/CaliFree3DLane/dataset/model/apollo/latest.pth' #model path of verification
...
tmp_save_path = '/media/sda2/CaliFree3DLane/tmp/tmp_apollo' #tmp path for save intermediate result
...
class PostProcessDataset(Dataset):
    def __init__(self, model_res_save_path, postprocess_save_path,test_json_paths):
        ...
        self.d_gt_res = d_gt_res # json文件中所有车道线，一个图像中包含多条车道线
...
def val():
    dir = '/media/sda2/CaliFree3DLane/dataset/model/apollo'
    ...
    for ep in dir_list:
        ...
        for item in tqdm(res_list): # 472 apollo_3 ill
